...
Bootstrap delta-SR 95% CI for EAAG vs each CB method. Qwen3: 18/30 significant across 5 environments. Bootstrap with 5000 resamples, seed=42.

## Data Status

- Qwen3-4B: ✅ complete (data.csv, 31 rows). FEVER excluded (no CB comparison data).
- Phi-3.5-mini: TODO — recompute with Phi EAAG vs Phi CB data
...
- Qwen3 EAAG episodes: `results/phase6/path_e/{env}/se_online_decay_local/seed_{123,42,456}/episodes.json`
