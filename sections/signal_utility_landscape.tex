...
the same evidence will not resolve the ambiguity. Critically, even when rollouts simulate further env steps, those
steps draw observations from the \emph{same} information-bounded
environment; in Type~I settings, the evidence required is simply
not within that distribution (e.g., the relevant passage is not in
the retrievable corpus). In the first
