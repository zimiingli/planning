...
\item \textbf{Adaptive gating method.} We propose DIAL, which learns signal direction per environment instead of assuming it, outperforming all fixed-direction baselines across six environments with zero deployment overhead.
\end{itemize}
