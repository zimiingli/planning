...
shinn2023reflexion, zhou2024lats}. However, many tasks remain beyond the
...
However, test-time compute is expensive, incurring substantial per-step overhead (e.g., requiring multiple rollouts or candidate evaluations at each decision point)~\citep{yao2023tree, zhou2024lats}. As
...
\item \textbf{Empirical finding.} Signal–utility direction reverses across environments and model backbones, and the most informative signal itself differs across environments. All fixed-direction methods fail in at least two of eight environments.
