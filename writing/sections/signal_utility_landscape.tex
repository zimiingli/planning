...
gating fails; we now ask \emph{why}. We trace direction reversal
to a single mechanism: the conflation of two distinct sources of
uncertainty.
...
This direction reversal is closely related to Simpson's
