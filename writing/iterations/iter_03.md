...
### Setup
1. **Added Phase 1 requirements paragraph** (guide lines 860-867): Explains that CaTS/SEAG/CoRefine/SCG require 200 episodes of Phase 1 calibration data, while EAAG requires none. Clarifies the dagger notation and cost column scope.
...
4. **Added concluding sentence** (guide lines 1150-1153): "These results confirm that EAAG adapts not only direction but *magnitude* of gating..."
