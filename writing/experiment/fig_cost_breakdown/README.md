...
> Layout: Stacked bar chart. x = methods (DIAL, CaTS, SEAG, CoRefine, CATTS, AUQ, s1).
...
> DIAL highlighted with red border. Sort by total cost ascending.
> Key message: DIAL's 50-episode exploration overhead <= calibration overhead of other methods.
...
- Gate training time: negligible (<1s, from DIAL training logs)
