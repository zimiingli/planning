...
**版本**: v7.0 (2026-03-22) — 全面重写，聚焦论文最终实验设计
**前版**: v24.0 已归档至 `planning/archive/VOC_EXPERIMENT_IMPLEMENTATION_PLAN_v24.md`
...
**状态**: ✅ 数据已有，需生成图
**TODO**: `python plots/generate_feature_heatmap.py`
...
**状态**: 需要从 decision_log 提取数据
**TODO**: 写 analysis 脚本提取 trigger rate by step
...
- [ ] FEVER Path E 剩余 11 tasks → Job 23292522
- [ ] APPS Interview Path E 剩余 21 tasks → Job 23292522
- [ ] CRUXEval Path E 0/75 → Job 23292522 (appendix, 低优先)
...
```
Job 23292522: Path E 剩余 ~107 tasks (FEVER 11 + APPS Intv 21 + CRUXEval 75)
